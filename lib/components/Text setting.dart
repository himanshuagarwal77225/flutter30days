...
Text headerText(var text) {
  return Text(
    text,
    maxLines: 2,
      style: TextStyle(fontStyle: FontStyle.normal,color: Colors.black,fontWeight: FontWeight.w600,fontSize: 32)
...
Text subHeadingText(var text) {
  return Text(
    text,
    style: TextStyle( fontStyle: FontStyle.normal,fontSize: 17.5, color: Colors.black),
  );
}
